...
print("""sensorcommunity_combined_hu.py - Ez ötvözi a sensorcommunity.py és combined.py funkcióit
================================================================================
Sensor.Community INFO
Hőmérsékletet, nyomást, páratartalmat,
PM2.5 és PM10 értékeket olvas az Enviro plusból és elküldi az adatokat a Sensor.Community-nek,
a polgári tudomány levegőminőségi projektjének.

Megjegyzés: regisztrálnod kell a Sensor.Community-nél:
https://devices.sensor.community/ és be kell írnod a Raspberry Pi szériaszámodat,
amely megjelenik az Enviro plus LCD-jén, valamint a többi részletet, mielőtt az adatok megjelennek
a Sensor.Community térképén.

Kilépéshez nyomd meg a Ctrl+C-t!

========================================================================

Combined INFO:
Megjeleníti az összes Enviro plus szenzor adatokat
